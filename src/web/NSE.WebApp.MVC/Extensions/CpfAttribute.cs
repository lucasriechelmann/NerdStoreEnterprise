...
public class CpfAttribute : ValidationAttribute
{
    protected override ValidationResult IsValid(object value, ValidationContext validationContext) =>
        Cpf.Validate(value.ToString()) ? ValidationResult.Success : new ValidationResult("Invalid format for CPF");
}
...
public class CpfAttributeAdapter : AttributeAdapterBase<CpfAttribute>
{
    ...
    public override string GetErrorMessage(ModelValidationContextBase validationContext) => "Invalid format for CPF";
}
